export default function Location() {
  const googleMapsUrl = 'https://www.google.com/maps/search/?api=1&query=Av.+Tomillo+172,+Villa+Giardino,+Córdoba,+Argentina';
  const embedUrl = 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3398.4!2d-64.503!3d-31.071!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzHCsDA0JzE1LjYiUyA2NMKwMzAnMTEuOCJX!5e0!3m2!1ses!2sar!4v1620000000000!5m2!1ses!2sar';
  ...
  const CONTACT_ITEMS = [
    ...
    },
    {
      ...
      label: 'Instagram',
      value: '@cosa.nostrasc',
      href: 'https://instagram.com/cosa.nostrasc',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 border border-[#ffffff08] -mt-1">
          ...
          <div className="lg:col-span-1 p-10 border-b lg:border-b-0 lg:border-r border-[#ffffff08]">
            <span className="block text-[#9F2A1F] font-headline font-bold tracking-[0.2em] uppercase text-[10px] mb-6">
              Nuestra Sede
            </span>
            <h2 className="font-headline font-black text-4xl md:text-5xl uppercase tracking-tighter leading-none mb-6">
              ENCUÉN<br />TRANOS
            </h2>
            <address className="not-italic text-[#a78a86] text-sm leading-relaxed mb-8">
              Av. Tomillo 172<br />
              Villa Giardino (CP 5176)<br />
              Córdoba, Argentina
            </address>
            <a
              href={googleMapsUrl}
            ...
            <ul className="space-y-6">
              {CONTACT_ITEMS.map((item) => (
                <li key={item.label} className="flex items-start gap-4">
                  <span className="mt-0.5 text-[#9F2A1F] shrink-0">{item.icon}</span>
                  <div>
                    <p className="text-[9px] font-headline font-bold tracking-[0.2em] uppercase text-[#58413e] mb-1">
                      {item.label}
                    </p>
                    <a
                      href={item.href}
